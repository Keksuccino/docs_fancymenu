...
If you're using Essential in your modpack, you've probably already noticed that FancyMenu can't customize Essential's UI. This is not FancyMenu's fault and Essential needs to fix that on their side, but there's an okay-ish workaround for now. Essential now lets you completely disable their UI stuff they add to the game.
