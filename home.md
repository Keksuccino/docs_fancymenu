...
If you're looking for the v2 documentation, please go to [the FMv2 documentation](https://fm.keksuccino.dev) instead.
...
Anchor points are necessary for calculating an element's position and if used correctly, they save elements from overlapping each other or going out-of-screen when resizing the window.
