---
title: 布局模板
description: 如何为 FancyMenu、Spiffy 和 Drippy 获取完整、可直接使用的设计模板。
---
# 布局模板
...
> [!CAUTION]
> 社区模板可能会运行操作。请只从你信任的来源导入它们。

由于这些模板通常非常复杂，通常不建议尝试将模板与你现有的配置合并，因此你应该用模板中的 `fancymenu` 文件夹替换现有的 `fancymenu` 文件夹。

# 编辑模板或将其用于项目

该频道中的大多数模板都允许你对其进行编辑，甚至可将它们用于你自己的项目中，例如模组包，但非常重要的一点是，你**必须查看模板帖子，了解你被允许对其进行哪些操作**！
