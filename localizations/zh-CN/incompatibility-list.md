...
以下模组被认为在某种程度上与 FancyMenu 不兼容。

其中一些模组可以通过变通方法与 FancyMenu 配合使用。
如果是这种情况，会在下面列表中模组名称后注明。

**如果你发现了一个尚未收录在此列表中的不兼容模组，请在 GitHub 上提交 issue！非常感谢！**

* [Animated Loading Screen](https://modrinth.com/mod/animated-loading-screen)（会让菜单看起来出错）
* [Animated Mojang Logo](https://www.curseforge.com/minecraft/mc-mods/animated-mojang-logo)（布局有时无法加载；还会破坏 Drippy Loading Screen）
* [Bedrockify](https://www.curseforge.com/minecraft/mc-mods/bedrockify)（如果你禁用该模组的所有菜单修改功能，就兼容，至少对你想自定义的那些菜单是这样）
...
* [Colormatic](https://www.curseforge.com/minecraft/mc-mods/colormatic)（启动 MC 时严重卡顿，并会破坏 FM 的音频功能）
* [Controllable](https://www.curseforge.com/minecraft/mc-mods/controllable)（通过 Controllable 的“Virtual Mouse”功能无法点击使用 FancyMenu 添加到菜单中的自定义按钮）
* [Controlify](https://modrinth.com/mod/controlify)（似乎会导致游戏崩溃，但这边无法修复——更多背景请参见[此 issue](https://github.com/Keksuccino/FancyMenu/issues/1144)）
...
* [Dynamic Surroundings](https://www.curseforge.com/minecraft/mc-mods/dynamic-surroundings)（会破坏 FancyMenu 的音频元素，但其他功能应该都正常）
* [EnhancedVisuals](https://www.curseforge.com/minecraft/mc-mods/enhancedvisuals)（似乎会破坏动画，使背景半透明，可能还有其他问题）
* [Entity Model Features](https://modrinth.com/mod/entity-model-features)（会导致游戏崩溃，但这边无法修复——更多背景请参见[此 issue](https://github.com/Keksuccino/FancyMenu/issues/1115)）
...
* [Ice and Fire](https://www.curseforge.com/minecraft/mc-mods/ice-and-fire-dragons)（如果在配置中禁用自定义主菜单，则可用）
* [Jurassicraft](https://www.curseforge.com/minecraft/mc-mods/jurassicraft)（在启用其 GUI 的自定义功能时，启动会崩溃——请从 `config/fancymenu/customizablemenus.txt` 中删除它们）
...
* [Minecraft Comes Alive](https://www.curseforge.com/minecraft/mc-mods/minecraft-comes-alive-mca)（正常可用，但其菜单无法自定义）
* [MineTogether](https://www.curseforge.com/minecraft/mc-mods/creeperhost-minetogether)（当 GUI 缩放 > 2 时，似乎会破坏布局）
* [Mod Menu](https://www.curseforge.com/minecraft/mc-mods/modmenu)（在大多数情况下**完全正常**，但如果你遇到 Mods 按钮重复或无法自定义的情况，请将 Mod Menu 按钮设置改为“Adjacent”：Main Menu > Mods > Mod Menu > Mods Button: Adjacent）
...
* [Not Enough Animations](https://www.curseforge.com/minecraft/mc-mods/not-enough-animations)（在 1.16+ 中正常，但会破坏 1.12）
* **OptiFine**（会破坏该模组！请改用[这些替代方案](./optifine-alternatives)）
* [Optiscale](https://www.curseforge.com/minecraft/mc-mods/optiscale)（会破坏 FancyMenu 的界面；按钮无法点击）
* [Pack Menu](https://www.curseforge.com/minecraft/mc-mods/packmenu)
* [Panorama Screens](https://modrinth.com/mod/panorama-screens)（不会工作并且会引发问题，因为叠加多个菜单自定义模组从来都不是好主意）
* [QuestCraft](https://github.com/QuestCraftPlusPlus/QuestCraft)（游戏无法加载）
* [RandomPatches](https://www.curseforge.com/minecraft/mc-mods/randompatches-forge)（如果在其配置中设置 `patchMinecraftClass = false`，则可用）
* [Remove Reloading Screen](https://www.curseforge.com/minecraft/mc-mods/rrls)（会破坏 FM 和 Drippy。不要使用这个模组。）
* [Replay Mod](https://www.replaymod.com/download/)（如果在 `.minecraft/config/replaymod.json` 中将 `mainMenuButton` 设为 **BIG**，则可用）
* [Seamless Loading Screen](https://www.curseforge.com/minecraft/mc-mods/seamless-loading-screen)（会导致游戏崩溃）
* [Slight Gui Modifications](https://www.curseforge.com/minecraft/mc-mods/slight-gui-modifications)
* [Skin Layers 3D](https://www.curseforge.com/minecraft/mc-mods/skin-layers-3d)（在 1.16+ 中正常，但会破坏 1.12）
...
* [Stylish Effects](https://www.curseforge.com/minecraft/mc-mods/stylish-effects)（主菜单第一次显示时无法加载布局）
...
* [The Dalek Mod](https://www.curseforge.com/minecraft/mc-mods/the-dalek-mod)（如果在配置中禁用其自定义主菜单，则可用）
* [ThonkUtil](https://www.curseforge.com/minecraft/mc-mods/thonkutil)（可用，但目前会在主菜单中添加一段无法移除的文字）
* [Trade Uses](https://modrinth.com/mod/trade-uses)（会导致村民交易菜单崩溃——可能仅在同时安装了 “Easy Villagers” 时出现）
