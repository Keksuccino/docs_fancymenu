...
# Modified FancyMenu JAR Found

If you got that error, it's probably due to a broken Minecraft instance, broken mod loader or a bad mod launcher.

It normally shows when FancyMenu got modified, but it can also show if your game fails to correctly load mods like it's supposed to.
