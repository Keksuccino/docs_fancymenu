...
title: Known Issues
description: >-
  A list of known issues in the current FancyMenu version. Always up-to-date for
  the latest build.
---
...
### 1. Player Entity & Item elements are always in front of everything.
